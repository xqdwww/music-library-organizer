...
The v0.2 modules for scanning, entity resolution, rating evidence, calibration, scoring, local review controls, quarantine, rollback, purge, and SQLite state were reviewed against their repository history and imports. The only runtime third-party code is the separately installed Mutagen package, declared in `pyproject.toml` and `THIRD_PARTY_NOTICES.md`.
